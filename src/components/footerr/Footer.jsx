    ...
    <footer className='flex flex-col justify-center items-center font-sen w-[100%] bg-red-600 p-9'>
      <div className='flex lg:flex-row items-center lg:items-baseline flex-col justify-between w-[80%]'>
        <div className='flex w-32 h-32' data-aos='fade-up' data-aos-delay='1000'>
            <h1 className='text-white'>IMAGE LOGO PLACE HOLDER</h1>
        ...
        <div className='links_ul' data-aos='fade-up' data-aos-delay='1200'>
          ...
          <ul>
            ...
            <li className='mb-3 text-base cursor-pointer text-white text-center lg:text-justify'><a href='#brands'>Brands</a></li>
            <li className='mb-3 text-base cursor-pointer text-white text-center lg:text-justify'><a href='#features'>Features</a></li>
            <li className='mb-3 text-base cursor-pointer text-white text-center lg:text-justify'><a href='#pricing'>Pricing</a></li>
        ...
        <div className='flex flex-col p-2 md:w-auto w-[90vw] items-center lg:items-baseline'>
          ...
          <div className='text-base mb-4 text-white'>Over 25000 People Have Subscribed</div>
      ...
      <div className='flex flex-col w-[100%] justify-center items-center mt-3 mb-24' data-aos='fade-up' data-aos-delay='1800'>
        ...
        <p className='text-white'>2024 | Mustard Vision Technologies Ltd</p>
        <div className='text-white'>Copyright @2024 Mustard</div>
      </div>
    </footer>
  )
}
